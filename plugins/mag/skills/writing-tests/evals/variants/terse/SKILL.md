...
- Test paired operations at the same boundary.
- Use a clock or RNG fake that advances on every call.
- Expire several entries, not one.
- Assert nothing beyond the spec is accepted.
